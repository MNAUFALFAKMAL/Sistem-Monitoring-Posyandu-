...
const KaderLayout = () => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/kader', icon: Home },
    { name: 'Data Balita', href: '/kader/balita', icon: Baby },
    { name: 'Data Ibu Hamil', href: '/kader/ibu-hamil', icon: Users },
    { name: 'Jadwal Posyandu', href: '/kader/jadwal', icon: Calendar },
    { name: 'Pengaduan', href: '/kader/pengaduan', icon: MessageSquare },
  ]
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-primary-700">
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div className="flex-shrink-0 flex items-center px-4">
                <h1 className="text-white text-lg font-semibold">Sistem Posyandu</h1>
              </div>
            ...
            <div className="flex-shrink-0 flex bg-primary-800 p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs font-medium text-primary-200">Kader Posyandu</p>
                </div>
                <button
                  onClick={logout}
